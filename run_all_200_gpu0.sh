...
python3 test_script --new_test_set --load_path ./aved_models/CC_200_pretraining/model_best.pth
python3 test_script --new_test_set --load_path ./aved_models/CC_50_pretraining/model_best.pth
