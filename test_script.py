...
if __name__ == "__main__":
    ...
    res= pd.DataFrame({'id': id_patients,
                      'dice_sc':metrics[:,0],
    ...
    print('accuracy nb_lesions',(ground_truth == predictions).sum()/len(predictions))
    print('MSE',((ground_truth - predictions)**2).sum()/len(predictions))
    print('MSA',(abs(ground_truth - predictions)).sum()/len(predictions))