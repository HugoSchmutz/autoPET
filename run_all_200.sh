...
python3 test_script.py --new_test_set --load_path ./ai4pet_saved_models/CC_normal_CE_50_0.0_0_0.0_0.0005/model_best.pth --data_dir ai4pet_dataset/ --patients_list_dir ai4pet_dataset/
python3 test_script.py --new_test_set --load_path ./ai4pet_saved_models/FT_CC_normal_CE_50_0.0_0_0.0_0.0005/model_best.pth --data_dir ai4pet_dataset/ --patients_list_dir ai4pet_dataset/

python3 new_train.py --data_dir ai4pet_dataset/ --patients_list_dir ai4pet_dataset/ --overwrite --rank 0 --gpu 1 --num_labels 50 --ulb_loss_ratio 0.0 --num_iter 10000 --max_queue_length 1000 --num_workers 12 --save_dir ai4pet_saved_models/ --dropout 0.0 --ulb_loss_ratio 0.1 --SegPL_U --ulb_loss_fct maskedDiceCE --mean_teacher --finetune --load_path ai4pet_saved_models/CC_normal_CE_50_0.0_0_0.0_0.0005/model_best.pth
